...
function ComingSoon() {
  ...
  const updateTimer = (targetDate) => {
    ...
    const remainingHours = Math.floor((timeLeft % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60)); // Hours
    const remainingMinutes = Math.floor((timeLeft % (1000 * 60 * 60)) / (1000 * 60)); // Minutes
        ...
        <Row>
          <Col xs={{ span: 12 }}>
            <div className={classes.content}>
              <h2 className={classes.subtitle}>Victory Builders is</h2>
              <h2 className={classes.subtitle}>
                <span>Coming Soon</span>
              </h2>
              <p className={classes.desc}>
              Stay tuned, Victory Builders is launching soon. Thank you for your patience.
              </p>
              ...
              <div style={timerStyles}>
                ...
                <div style={timeSectionStyles}>
                  <div style={timeNumberStyles}>{minutes}</div>
                  <span style={timeLabelStyles}>Minutes</span>
                </div>
                <div style={timeSectionStyles}>
                  <div style={timeNumberStyles}>{seconds}</div>
